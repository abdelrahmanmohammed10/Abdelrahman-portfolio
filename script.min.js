...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (canvas) {
    ...
    const numClouds = window.innerWidth > 768 ? 16 : 8; 
    ...
    class Comet {
      ...
      reset() {
        ...
        if (dir === 1) {
          ...
          this.y = -50;
          const angle = Math.PI * 0.25 + (Math.random() - 0.5) * 0.15; 
    ...
    class Star {
      ...
      reset() {
        ...
        if (sizeRand > 0.88) this.z = Math.random() * 1.3 + 0.7; 
        ...
        else if (this.color === '#4F46E5') { this.rgb = { r: 79, g: 70, b: 229 }; }   
